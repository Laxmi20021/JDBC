package com.xworkz.account.mainrunner;
...
import com.xworkz.account.read.SelectQuery1;
import com.xworkz.account.read.SelectQuery2;
import com.xworkz.account.read.SelectQuery3;
import com.xworkz.account.read.SelectQuery4;
import com.xworkz.account.read.SelectQuery5;
import com.xworkz.account.read.SelectQuery6;
import com.xworkz.account.ref.ConnectionEnum;

public class AccountmainRunner {
	...
	public static void main(String[] args) {
		...
		//else
			...
			while (resultSet3.next()) {
				System.out.println(resultSet3.getString("city"));
			}
			System.out.println(".......................");
